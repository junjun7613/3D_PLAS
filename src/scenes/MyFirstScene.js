import { Engine, Scene, ArcRotateCamera, Vector3, MeshBuilder, StandardMaterial, Color3, HemisphericLight, ActionManager, ExecuteCodeAction, DynamicTexture, SceneLoader, Axis, Space } from "@babylonjs/core";
import * as BABYLON from 'babylonjs';
import * as Materials from 'babylonjs-materials';
import {GUI} from "babylonjs-gui";
import {StackPanel, TextBlock, Button, ScrollViewer, Control, Grid, Image, SelectionPanel, CheckboxGroup, RadioGroup} from "@babylonjs/gui";
...
const createScene = (canvas) => {
    ...
    for (let i = 0; i < objectData.length; i++) {
        ...
        let resolve = SceneLoader.ImportMeshAsync("", "./models/", objectData[i].url, scene).
                    ...
                    for (const transcription of transcriptions) {
                        ...
                        for (const tx of texts) {
                            ...
                            var makeCard = function (title, positionObject) {
                                ...
                                let ttl = new TextBlock(tx.title);
                                ttl.text = tx.title;
                                ttl.color = "black";
                                ttl.fontSize = 150;
                                ttl.height = "200px";
                                ...
                                let button1 = Button.CreateSimpleButton("but1", "Show text");
                                button1.width = 1;
                        ...
                        var makeCard = function (item, itemDetail, positionObject, detailCardPosition) {
                            ...
                            var makeDetailCard = function (positionObject) {
                                ...
                                for (let i = 0; i < itemDetailKeys.length; i++) {
                                    ...
                                    Info.textVerticalAlignment = Control.VERTICAL_ALIGNMENT_TOP;
                            ...
                            let title = new TextBlock(item.title);
                            ...
                            let button1 = Button.CreateSimpleButton("but1", "Text");
                            button1.width = 0.4;
                            button1.height = "200px";
                            button1.color = "white";
                            ...
                            let button2 = Button.CreateSimpleButton("but2", "Image");
                            button2.width = 0.45;
    ...
    Promise.all(resolveArray).then(() => {
        ...
        for (const mesh of listMeshes) {
            ...
            var transformGroup = new CheckboxGroup("Certainty");
